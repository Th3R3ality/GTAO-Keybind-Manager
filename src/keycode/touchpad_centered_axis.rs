pub const CATEGORY: &'static(&'static str, &'static str) = &("IOMS_TOUCHPAD_CENTERED_AXIS", "PS4/5 controller touchpad axis input (centered)");
...
pub const ALL: &'static[&'static(&'static str,&'static str)] = &[
	CATEGORY, //PS4/5 controller touchpad axis input (centered)
