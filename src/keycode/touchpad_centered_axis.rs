pub const IOMS_TOUCHPAD_CENTERED_AXIS: &'static(&'static str, &'static str, &'static str) = &("IOMS_TOUCHPAD_CENTERED_AXIS", "Touchpad Centered Axis", "PS4/5 controller touchpad axis input (centered)");
