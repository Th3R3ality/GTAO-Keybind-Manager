pub const IOMS_PAD_DIGITALBUTTON: &'static(&'static str, &'static str, &'static str) = &("IOMS_PAD_DIGITALBUTTON", "PAD_DIGITALBUTTON", "Controller button input");
...
pub const ALL: &'static[&'static(&'static str, &'static str, &'static str)] = &[
	IOMS_PAD_DIGITALBUTTON, //Controller button input
