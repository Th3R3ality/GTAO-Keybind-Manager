pub const CATEGORY: &'static(&'static str, &'static str) = &("IOMS_MOUSE_BUTTONANY", "Mouse button input (no known difference from MOUSE_BUTTON)");
...
pub const ALL: &'static[&'static(&'static str,&'static str)] = &[
	CATEGORY, //Mouse button input (no known difference from MOUSE_BUTTON)
