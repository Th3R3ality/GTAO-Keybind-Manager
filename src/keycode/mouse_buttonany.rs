pub const IOMS_MOUSE_BUTTONANY: &'static(&'static str, &'static str, &'static str) = &("IOMS_MOUSE_BUTTONANY", "Mouse Buttonany", "Mouse button input (no known difference from MOUSE_BUTTON)");
