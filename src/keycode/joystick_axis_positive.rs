pub const IOMS_JOYSTICK_AXIS_POSITIVE: &'static(&'static str, &'static str, &'static str) = &("IOMS_JOYSTICK_AXIS_POSITIVE", "Joystick Axis Positive", "Joystick / flight stick axis input (always positive)");
