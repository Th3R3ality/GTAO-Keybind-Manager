pub const IOMS_JOYSTICK_AXIS_NEGATIVE: &'static(&'static str, &'static str, &'static str) = &("IOMS_JOYSTICK_AXIS_NEGATIVE", "Joystick Axis Negative", "Joystick / flight stick axis input (always negative)");
