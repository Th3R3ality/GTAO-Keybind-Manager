pub const IOMS_MOUSE_ABSOLUTEAXIS: &'static(&'static str, &'static str, &'static str) = &("IOMS_MOUSE_ABSOLUTEAXIS", "MOUSE_ABSOLUTEAXIS", "Mouse axis input (absolute)");
...
pub const ALL: &'static[&'static(&'static str, &'static str, &'static str)] = &[
	IOMS_MOUSE_ABSOLUTEAXIS, //Mouse axis input (absolute)
