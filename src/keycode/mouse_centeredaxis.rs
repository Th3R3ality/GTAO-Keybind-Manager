pub const IOMS_MOUSE_CENTEREDAXIS: &'static(&'static str, &'static str, &'static str) = &("IOMS_MOUSE_CENTEREDAXIS", "MOUSE_CENTEREDAXIS", "Mouse axis input (centered)");
...
pub const ALL: &'static[&'static(&'static str, &'static str, &'static str)] = &[
	IOMS_MOUSE_CENTEREDAXIS, //Mouse axis input (centered)
