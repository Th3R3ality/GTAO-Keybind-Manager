pub const CATEGORY: &'static(&'static str, &'static str) = &("IOMS_PAD_DIGITALBUTTONANY", "Controller button input (no known difference from PAD_DIGITALBUTTON)");
...
pub const ALL: &'static[&'static(&'static str,&'static str)] = &[
	CATEGORY, //Controller button input (no known difference from PAD_DIGITALBUTTON)
