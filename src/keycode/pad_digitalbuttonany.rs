pub const IOMS_PAD_DIGITALBUTTONANY: &'static(&'static str, &'static str, &'static str) = &("IOMS_PAD_DIGITALBUTTONANY", "Pad Digitalbuttonany", "Controller button input (no known difference from PAD_DIGITALBUTTON)");
