pub const IOMS_TOUCHPAD_ABSOLUTE_AXIS: &'static(&'static str, &'static str, &'static str) = &("IOMS_TOUCHPAD_ABSOLUTE_AXIS", "Touchpad Absolute Axis", "PS4/5 controller touchpad axis input (absolute)");
