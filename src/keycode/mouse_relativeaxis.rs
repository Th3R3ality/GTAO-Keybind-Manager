pub const IOMS_MOUSE_RELATIVEAXIS: &'static(&'static str, &'static str, &'static str) = &("IOMS_MOUSE_RELATIVEAXIS", "MOUSE_RELATIVEAXIS", "Mouse axis input (relative)");
...
pub const ALL: &'static[&'static(&'static str, &'static str, &'static str)] = &[
	IOMS_MOUSE_RELATIVEAXIS, // Mouse axis input (relative)
